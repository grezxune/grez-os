...
Personal and legacy notes live outside the repository for portability and privacy.
...
- The CLI slash commands read and write to that external location. Keep this directory to document expectations.
